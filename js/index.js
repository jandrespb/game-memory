...
const titulos = Array.from({ length: 15 }, (_, i) => document.getElementById(`titulo_${i + 1}`));
const conceptos = Array.from({ length: 15 }, (_, i) => document.getElementById(`concepto_${i + 1}`));
